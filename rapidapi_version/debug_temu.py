#!/usr/bin/env python3
"""
Debug script to inspect Temu's actual HTML structure
"""
...
def debug_temu():
    print("🔍 Debugging Temu HTML Structure...")
    ...
    try:
        ...
        with open('temu_debug.html', 'w', encoding='utf-8') as f:
            f.write(html)
        
        print("✅ Saved HTML to temu_debug.html")
        ...
        driver.quit()
        print("\n✅ Debug complete. Check temu_debug.html for full HTML")
